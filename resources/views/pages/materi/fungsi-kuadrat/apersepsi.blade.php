...
<div style="text-align: center">
    <img
        src="{{ asset('assets/img/app/long-jump.png') }}"
        alt="Gambar 1 Lintasan Lompat Jauh"
...
<p>
    &nbsp;&nbsp;&nbsp;&nbsp; Parabola merupakan bentuk fungsi kuadrat dalam
    grafik. Fungsi kuadrat adalah fungsi polinom (suku banyak) dengan pangkat
    tertinggi variabelnya adalah 2. Fungsi kuadrat adalah sebuah fungsi
    matematika, yang dinyatakan dalam bentuk persamaan, yaitu persamaan yang
    memiliki bentuk umum 𝑓(𝑥) = 𝑎𝑥2 + 𝑏𝑥 + 𝑐 dimana a, b, dan c adalah
    konstanta-konstanta tertentu dan x adalah variable independent. Gambar
    berikut ini menunjukkan grafik fungsi kuadrat. Posisi bola merupakan posisi
    titik dalam sistem koordinat.
</p>
<div style="text-align: center">
    <img
        src="{{ asset('assets/img/app/graph-1.png') }}"
        alt="Gambar 2 Grafik Fungsi Kudrat"
        style="text-align: center"
        width="40%"
    />
...
<p style="text-align: center; margin-bottom: 5px;">
    Tabel 1. Kata Kunci Fungsi Kuadrat
</p>
<table class="table table-bordered mt-3">
    <tbody>
        ...
        <tr>
            <td>
                Fungsi kuadrat, parabola, persamaan kuadrat, minimum dan
                maksimum, titik puncak, sumbu simetri, titik potong dengan
